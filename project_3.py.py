...
model = joblib.load('D:/project 3/cleaned_dataset/car_price_prediction_model.pkl')
label_encoders = joblib.load('D:/project 3/cleaned_dataset/label_encoders.pkl')
scalers = joblib.load('D:/project 3/cleaned_dataset/scalers.pkl')

# Load dataset for filtering and identifying similar data
data = pd.read_csv('D:/project 3/cleaned_dataset/car_dekho_cleaned_dataset_Raw.csv')
...
mileage = st.sidebar.number_input('11. Mileage (kmpl)', min_value=0, max_value=40, value=0)
